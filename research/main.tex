...
\section{Background}
    ...
    \subsection{Natural language processing}
        ...
        \subsubsection{Preprocessing}
            ...
            Tokenization also has limitations for the Arabic language, owing to the complexity of the language, words like "\RL{عقد}" and "\RL{جد}" depending on the context or pronunciation could lead to different meanings, also there are huge differences in formal (which we'll define in section \ref{thearabiclanguage}) and informal Arabic, as well as different dialects having vastly different sentence structure. and not just in Arabic this is also true for most languages, and that is one of the challenges of tokenization.
...
% 2.1: Still (mussaad gimme reference)
% 3.2: Done except figure 5, lets discuss on thursday
% 3.3: Done except the researcher, lets discuss on thursday. Also regarding figure 7, accuracy is reported, not precision. Also, weighted voting scored even higher! more details at page 118 here https://etheses.whiterose.ac.uk/23600/1/Areej%20Alshutayri%20Thesis.pdf
% Every other comment has been addressed!