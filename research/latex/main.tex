...
The discussed problem in this research has been tackled by many researchers over the years with varying results. in this section we intend to highlight the most important results regarding the Arabic language, the Arabic corpora and dialect classification methods that have been concluded from past research.
    ...
    \begin{figure}[h]
            % \hskip-3.3cm
            \centering
            \includegraphics[scale=0.7]{Figures/website.png}
            \caption{Arabic Dialect Classification website}
            \label{fig:website}
        \end{figure}
    
    \subsection{Demonstration}
            We wanted to showcase our project to further demonstrate our work and show our results. We also wanted to make it accessible for those who want to try it out for themselves, and to get feedback on our predictions to possibly further improve our results.
            
            Our website is as shown in Figure \ref{fig:website}, we provided two models to choose from, BERT and BAYES. We also provided samples of sentences in different dialects to conveniently try out the classifier.
            
            Prediction results will be displayed as shown in Figure \ref{fig:demo_example}, users then can give their feedback on whether the prediction was correct or not, if not, they can choose the correct dialect that the text belongs to, which will be saved on our database. All steps are shown in Figure \ref{fig:struct}
            
        \begin{figure}[h]
            % \hskip-3.3cm
            \centering
            \includegraphics[scale=0.7]{Figures/livedemo.png}
            \caption{Live demo example}
        ...
        \begin{figure}[h]
            % \hskip-3.3cm
            \centering
            \includegraphics[scale=0.6]{Figures/steps_v2.png}
            \caption{Demonstration structure}
            \label{fig:struct}
        \end{figure}
    ...
    \vskip0.5cm
    And also, the confusion matrix for the test set.
    \vskip0.5cm
    \hskip-0.32cm
    \begin{tabular}{lrrrrr}
    \toprule
...
\end{document}https://www.overleaf.com/project/613a35976c4585523984de56